...
acticity_list = {
    ...
    # non-chosen activity
    '豔陽高照': {'3hr': ['Wx','PoP12h','AT','WS','CI'],
            '12hr': ['Wx','PoP12h','MaxAT','WS','MaxCI','UVI']},
    '風和日麗': {'3hr': ['Wx','PoP12h','AT','WS','CI'],
            '12hr': ['Wx','PoP12h','MaxAT','WS','MaxCI','UVI']},
    '涼爽乾燥': {'3hr': ['Wx','PoP12h','AT','WS','CI'],
            '12hr': ['Wx','PoP12h','MaxAT','WS','MaxCI','UVI']},
    '溼冷有風': {'3hr': ['Wx','PoP12h','AT','WS','CI'],
            '12hr': ['Wx','PoP12h','MaxAT','WS','MaxCI','UVI']}   
}
...
activity_ref_list=  {
    ...
    # non-chosen activity
    '豔陽高照': { '降雨機率': 0, '體感溫度': 30, '風速': 3, '舒適度指數': 26, '紫外線指數': 6},
    '風和日麗': { '降雨機率': 0, '體感溫度': 28, '風速': 1, '舒適度指數': 23, '紫外線指數': 5},
    '涼爽乾燥': { '降雨機率': 0, '體感溫度': 25, '風速': 3, '舒適度指數': 17, '紫外線指數': 3},
    '溼冷有風': { '降雨機率': 60, '體感溫度': 20, '風速': 5, '舒適度指數': 13, '紫外線指數': 3}
}
